...
> 插件从发现到卸载的完整流程——扫描、依赖解析、加载、Mixin 钩子链、卸载。
...
- [事件处理](4.event-handling.md) — 深入三种事件消费模式
- [Mixin 能力体系](5.mixins.md) — 了解各 Mixin 钩子在生命周期中的作用
- [高级主题](7.advanced.md) — 热重载如何利用完整的加载/卸载周期
