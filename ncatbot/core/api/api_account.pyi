...
class AccountAPI:
    ...
    async def delete_friend(self, user_id: Union[str, int], block: bool = ..., both: bool = ...) -> None: ...
    def delete_friend_sync(self, user_id: Union[str, int], block: bool = ..., both: bool = ...) -> None: ...
    ...
    async def send_like(self, user_id: Union[str, int], times: int = ...) -> Dict[str, Any]: ...
    def send_like_sync(self, user_id: Union[str, int], times: int = ...) -> Dict[str, Any]: ...
    async def set_friend_add_request(self, flag: str, approve: bool, remark: Optional[str] = ...) -> None: ...
    def set_friend_add_request_sync(self, flag: str, approve: bool, remark: Optional[str] = ...) -> None: ...
    ...
    async def set_online_status(self, status: int, ext_status: int, battery_status: int) -> None: ...
    def set_online_status_sync(self, status: int, ext_status: int, battery_status: int) -> None: ...
