...
class GroupAPI:
    ...
    def get_essence_msg_list_sync(self, group_id: Union[str, int]) -> List['EssenceMessage']: ...
    ...
    async def get_group_files_by_folder(self, group_id: Union[str, int], folder_id: str, file_count: int = ...) -> dict: ...
    def get_group_files_by_folder_sync(self, group_id: Union[str, int], folder_id: str, file_count: int = ...) -> dict: ...
    ...
    async def get_group_root_files(self, group_id: Union[str, int], file_count: int = ...) -> dict: ...
    def get_group_root_files_sync(self, group_id: Union[str, int], file_count: int = ...) -> dict: ...
    ...
    async def group_file_folder_makedir(self, group_id: Union[str, int], path: str) -> Optional[str]: ...
    def group_file_folder_makedir_sync(self, group_id: Union[str, int], path: str) -> Optional[str]: ...
    ...
    async def post_group_file(self, group_id: Union[str, int], image: Optional[str] = ..., record: Optional[str] = ..., video: Optional[str] = ..., file: Optional[str] = ...) -> str: ...
    def post_group_file_sync(self, group_id: Union[str, int], image: Optional[str] = ..., record: Optional[str] = ..., video: Optional[str] = ..., file: Optional[str] = ...) -> str: ...
    ...
    async def set_group_ban(self, group_id: Union[str, int], user_id: Union[str, int], duration: int = ...) -> None: ...
    def set_group_ban_sync(self, group_id: Union[str, int], user_id: Union[str, int], duration: int = ...) -> None: ...
    ...
    async def set_group_kick(self, group_id: Union[str, int], user_id: Union[str, int], reject_add_request: bool = ...) -> None: ...
    def set_group_kick_sync(self, group_id: Union[str, int], user_id: Union[str, int], reject_add_request: bool = ...) -> None: ...
    async def set_group_leave(self, group_id: Union[str, int], is_dismiss: bool = ...) -> None: ...
    def set_group_leave_sync(self, group_id: Union[str, int], is_dismiss: bool = ...) -> None: ...
    ...
    async def set_group_special_title(self, group_id: Union[str, int], user_id: Union[str, int], special_title: str = ..., duration: int = ...) -> None: ...
    def set_group_special_title_sync(self, group_id: Union[str, int], user_id: Union[str, int], special_title: str = ..., duration: int = ...) -> None: ...
    async def set_group_todo(self, group_id: Union[str, int], message_id: Union[str, int]) -> dict: ...
    def set_group_todo_sync(self, group_id: Union[str, int], message_id: Union[str, int]) -> dict: ...
    ...
    async def upload_group_file(self, group_id: Union[str, int], file: str, name: str, folder: Optional[str] = ...) -> None: ...
    def upload_group_file_sync(self, group_id: Union[str, int], file: str, name: str, folder: Optional[str] = ...) -> None: ...
    async def upload_image_to_group_album(self, group_id: Union[str, int], file: str, album_id: str = ..., album_name: str = ...) -> None: ...
    def upload_image_to_group_album_sync(self, group_id: Union[str, int], file: str, album_id: str = ..., album_name: str = ...) -> None: ...