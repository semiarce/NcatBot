...
class PrivateAPI:
    ...
    async def post_private_file(self, user_id: Union[str, int], image: Optional[str] = ..., record: Optional[str] = ..., video: Optional[str] = ..., file: Optional[str] = ...) -> str: ...
    def post_private_file_sync(self, user_id: Union[str, int], image: Optional[str] = ..., record: Optional[str] = ..., video: Optional[str] = ..., file: Optional[str] = ...) -> str: ...
